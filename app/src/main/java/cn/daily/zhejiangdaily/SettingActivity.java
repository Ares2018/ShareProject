            ...
            sendBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!TextUtils.isEmpty(text)) {
                        ShareUtils.shareText(SettingActivity.this, text, share_media, shareListener);
                    } else {
            ...
            sendBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!TextUtils.isEmpty(text)) {
                        ...
                        ShareUtils.shareImage(SettingActivity.this, img, getImageThumb(thumb), share_media, shareListener);
                    } else {
                        Toast.makeText(SettingActivity.this, "参数不完整", Toast.LENGTH_LONG).show();
                    }
                }
            ...
            sendBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!TextUtils.isEmpty(title)
                        ...
                        ShareUtils.shareUrl(SettingActivity.this, web, share_media, shareListener);
                    } else {
                        Toast.makeText(SettingActivity.this, "参数不完整", Toast.LENGTH_LONG).show();
                    }
